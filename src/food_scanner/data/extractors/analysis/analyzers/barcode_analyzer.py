"""
src/food_scanner/data/extractors/analysis/analyzers/barcode_analyzer.py
...
class BarcodeAnalyzer(BaseFieldAnalyzer):
    ...
    def analyze_barcode_from_extracted_products(self, extracted_products: Dict[str, Any]) -> FieldAnalysisResult:
        """
        ...
        result.pattern_analysis = {
            ...
            "leading_zeros_analysis": self._finalize_barcode_leading_zeros_analysis(leading_zeros_analysis),
            "extraction_consistency": self._analyze_barcode_extraction_consistency(extracted_products)
        }
        ...
        result.examples = {
            ...
            "length_examples": self._get_barcode_length_examples(extracted_products, valid_lengths)
        }
    ...
    def _validate_extracted_barcode(
        ...
        if not self._is_barcode_numeric_string(extracted_barcode):
    ...
    def _analyze_barcode_extraction_consistency(self, extracted_products: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _finalize_barcode_leading_zeros_analysis(self, leading_zeros_analysis: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _get_barcode_length_examples(self, extracted_products: Dict[str, Any], valid_lengths: Counter) -> Dict[str, List]:
        ...
        for length in sorted(valid_lengths.keys()):
            ...
            for barcode, product_data in extracted_products.items():
                ...
                if (extracted_barcode and 
                    ...
                    self._is_barcode_numeric_string(extracted_barcode) and 
    ...
    def _is_barcode_numeric_string(self, barcode: str) -> bool:
...
if __name__ == "__main__":
    ...
    result = analyzer.analyze_barcode_from_extracted_products(mock_extracted_products)
