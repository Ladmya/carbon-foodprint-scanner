"""
src/food_scanner/data/extractors/analysis/analyzers/co2_analyzer.py
...
class CO2Analyzer(BaseFieldAnalyzer):
    ...
    def analyze_co2_from_extracted_products(self, extracted_products: Dict[str, Any]) -> FieldAnalysisResult:
        """
        Main entry point for analyzing CO2 data from ALL the extracted products
        ...
        for barcode, product_data in extracted_products.items():
            # Safety check: ensure product_data is a dict
            if not isinstance(product_data, dict):
                print(f"      ⚠️ Warning: product_data for {barcode} is {type(product_data)}, expected dict")
                continue
            ...
            self._analyze_co2_from_extracted_product(
        ...
        result.pattern_analysis = {
            ...
            "extraction_success_analysis": self._analyze_co2_extraction_patterns(extracted_products)
        }
    ...
    def _analyze_co2_from_extracted_product(
        self,
        barcode: str,
        ...
        """Analyze CO2 extraction for ONE SINGLE product"""
        ...
        if has_co2:
            ...
            if selected_co2_value is not None:
                ...
                if self._is_valid_co2_value(selected_co2_value):
                    ...
                    self._add_example(examples, "found", {
                        ...
                        "confidence": self._get_co2_source_confidence(selected_source),
            ...
            missing_reason = self._analyze_co2_extraction_failure(co2_sources, raw_api_data)
            ...
            self._add_example(examples, "missing", {
                ...
                "raw_structures_present": self._check_co2_raw_structures(raw_api_data)
            })
    
    def _analyze_co2_extraction_failure(self, co2_sources: Dict[str, Optional[float]], raw_api_data: Dict[str, Any]) -> str:
    ...
    def _check_co2_raw_structures(self, raw_api_data: Dict[str, Any]) -> Dict[str, bool]:
    ...
    def _get_co2_source_confidence(self, source: str) -> str:
    ...
    def _analyze_co2_extraction_patterns(self, extracted_products: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _calculate_co2_statistics(self, co2_values: List[float]) -> Dict[str, Any]:
        ...
        return {
            ...
            "min": min(co2_values),
            "max": max(co2_values),
            "std_dev": self._calculate_standard_deviation(co2_values),
            "percentiles": {
    ...
    def _analyze_source_reliability(self, found_examples: List[Dict]) -> Dict[str, Any]:
        ...
        for source, data_points in source_reliability.items():
            ...
            reliability_analysis[source] = {
                ...
                "standard_deviation": self._calculate_standard_deviation(values) if len(values) > 1 else 0,
...
if __name__ == "__main__":
    ...
    result = analyzer.analyze_co2_from_extracted_products(mock_extracted_products)
