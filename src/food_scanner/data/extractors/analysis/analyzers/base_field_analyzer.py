"""
src/food_scanner/data/extractors/analysis/analyzers/base_field_analyzer
Base class for all field analyzers with common functionality
Will be used by all field analyzers in src/food_scanner/data/extractors/analysis/analyzers/
"""
...
class BaseFieldAnalyzer(ABC):
    ...
    RESPONSIBILITY: Shared interface & basic metrics
