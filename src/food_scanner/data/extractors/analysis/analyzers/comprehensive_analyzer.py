"""
src/food_scanner/data/extractors/analysis/analyzers/comprehensive_analyzer.py
...
class ComprehensiveExtractionAnalyzer:
    ...
    def _run_specialized_analysis(self, extracted_products: Dict[str, Any]) -> Dict[str, FieldAnalysisResult]:
        ...
        try:
            co2_analyzer = CO2Analyzer()
            co2_result = co2_analyzer.analyze_co2_from_extracted_products(extracted_products)
            specialized_results["co2_total"] = co2_result
            # Safe access to valid_count
            valid_count = getattr(co2_result, 'valid_count', 0) if co2_result else 0
            print(f"      ✅ CO2 analysis completed: {valid_count} products with CO2 data")
        ...
        # barcode_result = barcode_analyzer.analyze_barcode_from_extracted_products(extracted_products)
